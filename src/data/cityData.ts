export const cityData = [
    ...
    },
    {
      city: "경기도",
      districts: [
        "수원시", "성남시", "고양시", "용인시", "부천시", "안산시", "안양시", "광명시", 
        "평택시", "시흥시", "파주시", "이천시", "오산시", "김포시", "광주시", "하남시", 
        "구리시", "양주시", "동두천시", "과천시", "의왕시", "포천시", "여주시", "여주군", 
        "가평군", "양평군", "연천군", "동두천시", "안성시"
      ],
    },
    {
      city: "강원도",
      districts: [
        ...
        "영월군", "평창군", "정선군", "철원군", "화천군", "양구군", "인제군", "고성군", 
        "양양군"
      ],
    },
    {
    ...
    },
    {
      city: "전라남도",
      districts: [
        "광주시", "목포시", "여수시", "순천시", "나주시", "광양시", "담양군", "곡성군", 
    ...
    },
    {
      ...
      districts: [
        ...
        "의령군", "함안군", "창녕군", "고성군", "남해군", "하동군", "산청군", "거창군", 
        "합천군"
      ],
    },
    {
